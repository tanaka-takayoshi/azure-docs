...
The following examples use [az vm user](/cli/azure/vm/user) along with the appropriate parameters. To perform these steps, you need the latest [Azure CLI 2.0](/cli/azure/install-az-cli2) installed and logged in to an Azure account using [az login](/cli/azure/#login).
